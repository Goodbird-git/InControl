...
public interface RuleKeys {
    ...
    Key<Float> ACTION_ARMORSET = Key.create(Type.FLOAT, "armorset");
    ...
    Key<Float> ACTION_ARMORTOUGHNESSSET = Key.create(Type.FLOAT, "armortoughnessset");
    ...
    Key<Float> ACTION_ATTACKSPEEDSET = Key.create(Type.FLOAT, "attackspeedset");
    Key<Float> ACTION_ATTACKSPEEDMULTIPLY = Key.create(Type.FLOAT, "attackspeedmultiply");
    Key<Float> ACTION_ATTACKSPEEDADD = Key.create(Type.FLOAT, "attackspeedadd");
    ...
    Key<String> ACTION_CHANGENUMBER = Key.create(Type.STRING, "changenumber");
